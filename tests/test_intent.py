"""Task 2 — unit tests for intent parsing (Azure OpenAI, Arabic + English).

These call the real Azure OpenAI API and are skipped automatically if Azure
...
requires_azure = pytest.mark.skipif(
    not config.has_azure_openai(), reason="Azure OpenAI is not configured"
)
